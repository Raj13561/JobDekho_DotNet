<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="NewJob.aspx.cs" Inherits="Job_Dekho.Admin.NewJob" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="background-image: url('../Images/bg.jpg'); width: 100%; height: 720px; background-repeat: no-repeat; background-size: cover; background-attachment: fixed;">
        <div class="container pt-4 pb-4">
            ...
            <div class="row mr-lg-5 ml-1g-5 mb-3">
            ...
            <div class="row mr-lg-5 ml-1g-5 mb-3">
                <div class="col-md-12 pt-3">
                    <label for="txtDescription" style="font-weight: 600">Descriptione</label>
            ...
            <div class="row mr-lg-5 ml-1g-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtSalary" runat="server" CssClass="form-control" placeholder="Ex:25K/Month,7L/Year" required></asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="JobType is Required" ForeColor="red" ControlToValidate="ddlJobType" InitialValue="0" Display="Dynamic" SetFocusOnError="false"></asp:RequiredFieldValidator>
                </div>
            </div>
            ...
            <div class="row mr-lg-5 ml-1g-5 mb-3">
                <div class="col-md-6 pt-3">
                    <label for="txtCompany" style="font-weight: 600">Company/Organistion Name</label>
                    <asp:TextBox ID="txtCompany" runat="server" CssClass="form-control" placeholder="Enter Company Name" required></asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
                    <label for="ddlJobType" style="font-weight: 600">Job Type</label>
            ...
            <div class="row mr-lg-5 ml-1g-5 mb-3 pt-4">
                <div clss="col-md-3 col-md-offset-2 mb-3">
                    <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-block" BackColor="#7200cf" Text="Add Job" OnClick="btnAdd_Click"/>
                </div>
            </div>
        </div> 
    </div>
